<%-- 
    ...
    Created on : 28/09/2021, 09:41:32 PM
    Author     : hp
--%>
        ...
        <div class="container ml-4 mt-4">
            ...
            <form action="Controlador?menu=Movimiento" method="POST">
                <div class="form-row">
                    ...
                    <button type="submit" name="accion" value="buscaC" class="btn btn-warning">
        ...
        <div class="container mt-4 ml-4">
            ...
            <form action="Controlador?menu=Movimiento" method="POST">
                ...
                <div class="form-row">
                    ...
                    <button type="submit" name="accion" value="buscaP" class="btn btn-warning">
                        Buscar<i class="fas fa-search ml-1"></i>
                    </button>
                </div>
                <br>
                ...
                <button type="submit" name="accion" value="cargar" class="btn btn-primary">
                    Cargar<i class="fas fa-redo-alt ml-1"></i>
                </button>
            </form>
        </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-dark" href="Controlador?menu=Producto&accion=elimina&id=">
