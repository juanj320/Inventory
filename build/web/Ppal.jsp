...
<html>
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-light bg-info">
            ...
            <div class="dropdown">
                <button style="margin-right: 80px; border: none; "class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ${usuario.getUsua()}
                </button>
                <div class="dropdown-menu text-center" aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item" href="#">
                        <img src="img/user.png" alt="" style="height:60px"/>
                    </a>
                    <a class="dropdown-item" href="#">${usuario.getUsua()}</a>
